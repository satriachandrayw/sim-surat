...
<div class="form-group {{ $errors->has('file_surat') ? 'has-error' : ''}}">
    {!! Form::label('file_surat', 'File Surat', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::file('file_surat', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
        {!! $errors->first('file_surat', '<p class="help-block">:message</p>') !!}
    </div>
</div>



/* tambah "No Berkas", "File Surat" dan "Keterangan Berkas" */
