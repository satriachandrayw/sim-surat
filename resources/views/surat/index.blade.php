                            ...
                            <table class="table table-borderless">
                                ...
                                @foreach($surat as $item)
                                    <tr>
                                        ...
                                        <td> <a href="{{url('/images/File Surat/' . $item->file_surat) }}"> <i class="fa fa-pencil-square-o"  aria-hidden="true"></i> View</button></a> </td>
                                        <td> </td>
                                        <td>
                                            <a href="{{ url('/surat/' . $item->id . '/edit') }}" title="Edit Surat"><button class="btn btn-primary btn-xs">
